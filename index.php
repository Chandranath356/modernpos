...
| -----------------------------------------------------
| AUTHOR:     GIT Lanka.COM
| -----------------------------------------------------
| EMAIL:      info@GIT Lanka.com
| -----------------------------------------------------
| COPYRIGHT:    RESERVED BY GIT Lanka.COM
| -----------------------------------------------------
| WEBSITE:      http://GIT Lanka.com
| -----------------------------------------------------
*/
include("_init.php");
...
<head>
  ...
  <?php if ($store->get('favicon')): ?>
      <link rel="shortcut icon" href="assets/GITLanka/img/logo-favicons/<?php echo $store->get('favicon'); ?>">
  <?php else: ?>
  ...
  <?php if (DEMO || USECOMPILEDASSET) : ?>
    ...
    <!-- LOGIN COMBINED CSS -->
    <link type="text/css" href="assets/GITLanka/cssmin/login.css" rel="stylesheet">
  ...
  <?php else : ?>
    ...
    <!-- Theme CSS -->
    <link type="text/css" href="assets/GITLanka/css/theme.css" rel="stylesheet">

    <!-- Login CSS -->
    <link type="text/css" href="assets/GITLanka/css/login.css" rel="stylesheet">
  ...
  <?php if (DEMO || USECOMPILEDASSET) : ?>
    ...
    <!-- Login Combined JS -->
    <script src="assets/GITLanka/jsmin/login.js"></script>
  ...
  <?php else : ?>
    ...
    <!-- Common JS -->
    <script src="assets/GITLanka/js/common.js"></script>

    <!-- Login JS -->
    <script src="assets/GITLanka/js/login.js"></script>

  <?php endif; ?>

</head>
<body class="login-page">
<div class="hidden"><?php include('assets/GITLanka/img/iconmin/membership/membership.svg');?></div>
  ...
  <section class="login-box">
        ...
        <table class="table table-bordered table-striped">
          <tbody>
            <?php foreach (get_users() as $the_user) : ?>
              <?php if (in_array($the_user['email'], array('admin@GITLanka.com', 'cashier@GITLanka.com', 'salesman@GITLanka.com'))) : ?>
    ...
    <div class="copyright text-center">
      <p>&copy; <a href="https://gitl.lk">GITLanka</a>, v<?php echo settings('version'); ?></p>
    </div>
  </section>
