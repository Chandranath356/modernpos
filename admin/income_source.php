...
// Add Script
$document->addScript('../assets/GITLanka/angular/modals/IncomeSourceEditModal.js');
$document->addScript('../assets/GITLanka/angular/modals/IncomeSourceDeleteModal.js');
$document->addScript('../assets/GITLanka/angular/controllers/IncomeSourceController.js');
