...
// Add Script
$document->addScript('../assets/GITLanka/angular/modals/ProductEditModal.js');
$document->addScript('../assets/GITLanka/angular/controllers/ExpiredProductController.js');
