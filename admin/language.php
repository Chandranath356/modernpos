...
// Add Script
$document->addScript('../assets/GITLanka/angular/modals/LanguageCreateModal.js');
$document->addScript('../assets/GITLanka/angular/modals/LanguageEditModal.js');
$document->addScript('../assets/GITLanka/angular/controllers/LanguageController.js');
