...
// Add ScriptS
$document->addScript('../assets/GITLanka/angular/controllers/UserController.js');
$document->addScript('../assets/GITLanka/angular/controllers/UserProfileController.js');
$document->addScript('../assets/GITLanka/angular/controllers/ReportUserSellController.js');
$document->addScript('../assets/GITLanka/angular/controllers/UserLoginLogController.js');
