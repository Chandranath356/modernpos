...
<head>
    ...
    <?php if (store('favicon')): ?>
		<link rel="shortcut icon" href="../assets/GITLanka/img/logo-favicons/<?php echo store('favicon'); ?>">
	<?php else: ?>
		<link rel="shortcut icon" href="../assets/GITLanka/img/logo-favicons/nofavicon.png">
	<?php endif; ?>
	...
	<?php if (DEMO || USECOMPILEDASSET) : ?>
		...
		<link href="../assets/GITLanka/cssmin/pos<?php echo isRTL() ? '-rtl' : null;?>.css" type="text/css" rel="stylesheet">
	...
	<?php else : ?>
		...
		<!-- Filemanager CSS -->
	    <link href="../assets/GITLanka/css/filemanager/dialogs.css" type="text/css" rel="stylesheet">
	    <link href="../assets/GITLanka/css/filemanager/main.css" type="text/css" rel="stylesheet">

	    <!-- Theme CSS -->
	    <link href="../assets/GITLanka/css/theme.css" type="text/css" rel="stylesheet">

	    <!-- Skin Black CSS -->
	    <link href="../assets/GITLanka/css/skins/skin-black.css" type="text/css" rel="stylesheet">

	    <!-- Skin Blue CSS -->
	    <link href="../assets/GITLanka/css/skins/skin-blue.css" type="text/css" rel="stylesheet">

	    <!-- Skin Green CSS -->
	    <link href="../assets/GITLanka/css/skins/skin-green.css" type="text/css" rel="stylesheet">

	    <!-- Skin Red CSS -->
	    <link href="../assets/GITLanka/css/skins/skin-red.css" type="text/css" rel="stylesheet">

	    <!-- Skin Yellow CSS -->
	    <link href="../assets/GITLanka/css/skins/skin-yellow.css" type="text/css" rel="stylesheet">

	    <!-- Main CSS -->
	    <link href="../assets/GITLanka/css/main.css" type="text/css" rel="stylesheet">

		<!-- Skeleton CSS -->
		<link href="../assets/GITLanka/css/pos/skeleton.css" rel="stylesheet" type="text/css">

		<!-- Main CSS -->
		<link href="../assets/GITLanka/css/pos/pos.css" rel="stylesheet" type="text/css">

		<!-- Responsive CSS -->
		<link href="../assets/GITLanka/css/pos/responsive.css" rel="stylesheet" type="text/css">

		<?php if (isRTL()) :?>
            <link href="../assets/GITLanka/css/rtl.css" type="text/css" rel="stylesheet">
        <?php endif;?>
	...
	<style type="text/css">
		body::after { 
			content: ""; background: url(../assets/GITLanka/img/pos/patterns/<?php echo $user->getPreference('pos_pattern') ? $user->getPreference('pos_pattern') : 'armysuit.jpg'; ?>) repeat repeat;opacity: 0.4;filter: alpha(opacity=40);top: 0;left: 0;bottom: 0;right: 0;position: absolute;z-index: -1;
		}
...
<div class="hidden"><?php include('../assets/GITLanka/img/iconmin/icon.svg');?></div>
...
<?php include('../_inc/template/pos_skeleton.php'); ?>
						...
						<div class="contents">
							...
							<div id="item-list">
								...
								<div ng-show="showLoader" class="ajax-loader">
									<img src="../assets/GITLanka/img/loading2.gif">
								</div>
										...
										<table class="table table-hovered">
											<tbody>
												<tr ng-repeat="items in itemArray" class="invoice-item">
													...
													<td class="product-quantity" id="invoice-item-{{ items.id }}" style="width: 130px;">
														<input type="hidden" name="p_type" value="{{ items.pType }}">
														<button class="btn btn-xs btn-up" ng-click="addItemToInvoice(items.id,null,$index)" title="Increase"
														>
														<span class="fa fa-angle-up"></span>
														</button>
														<input type="text" name="item_price_{{ items.id }}" class="item_quantity text-center" id="item_quantity_{{ items.id }}" value="{{ items.quantity }}" data-itemid="{{ items.id }}"

														data-index="{{$index}}"
														 onClick="this.select();" ondrop="return false;" onpaste="return false;"
														 style="width:40px;max-width:40px;border-radius: 50px;border: 1px solid #ddd;padding-top:0;padding-bottom:0;">
														<span style="font-size:12px;"><i>{{ items.unitName }}</i></span>
														<button class="btn btn-xs btn-down increasebtn{{ items.id }}" ng-click="DecreaseItemFromInvoice(items.id,$index)" title="Decrease">
															<span class="fa fa-angle-down"></span>
														</button>
													</td>
													<td class="product-name" style="width: 258px;padding-left: 20px;">
														<span>{{ items.name }}</span>
													</td>
													<td style="width: 150px;padding-left: 29px">
														
												<input  ng-change="SingleProductDiscount($index)"  type="text" name="single-discount-amount" ng-model="singlediscountInput[$index]" ondrop="return false;" onpaste="return false;"autocomplete="off" style="
                                                background-color: #424242;color: #fff;border-radius: 50px;width: 100px;font-size: 1.4rem;
                                                text-align: center;
												">
														
													</td>
													<td class="product-price" style="width: 90px;padding-right: 20px;">
													...
													<td  class="product-subtotal" id="subTotal-{{$index}}">
									...
									<div id="invoice-calculation" class="clearfix">
										<table class="table">
											<tbody>
												...
												<tr class="pay-top">
													<td>
														<?php echo trans('label_total_discount'); ?>
													</td>
													<td class="text-right">
												...
												<tr>
													<td>
														<?php echo trans('label_delivery_charge'); ?>
													</td>
													<td class="text-right">
	...
	<?php if (DEMO || USECOMPILEDASSET) : ?>
		...
		<script src="../assets/GITLanka/jsmin/pos.js" type="text/javascript"></script>
	...
	<?php else : ?>
		...
		<!-- Angular JS -->
	    <script src="../assets/GITLanka/angularmin/angular.js" type="text/javascript"></script> 

	    <!-- AngularApp JS -->
	    <script src="../assets/GITLanka/angular/angularApp.js" type="text/javascript"></script>

	    <!-- Filemanager JS -->
	    <script src="../assets/GITLanka/angularmin/filemanager.js" type="text/javascript"></script>

	    <!-- Angular JS Modal -->
		<script src="../assets/GITLanka/angularmin/modal.js" type="text/javascript"></script>
		...
		<!-- IE JS -->
		<script src="../assets/GITLanka/js/ie.js" type="text/javascript"></script>

		<!-- Common JS -->
		<script src="../assets/GITLanka/js/common.js" type="text/javascript"></script>

		<!-- Main JS -->
		<script src="../assets/GITLanka/js/main.js" type="text/javascript"></script>

		<!-- POS Main JS -->
		<script src="../assets/GITLanka/js/pos/pos.js" type="text/javascript"></script>



<?php endif; ?>

<script src="../assets/GITLanka/angular/modals/AddInvoiceNoteModal.js" type="text/javascript"></script>
<script src="../assets/GITLanka/angular/modals/AddCustomerMobileNumberModal.js" type="text/javascript"></script>
<script src="../assets/GITLanka/angular/modals/HoldingOrderModal.js" type="text/javascript"></script>
<script src="../assets/GITLanka/angular/modals/HoldingOrderDetailsModal.js" type="text/javascript"></script>
<script src="../assets/GITLanka/angular/controllers/PosController.js" type="text/javascript"></script>
