...
// Add Script
$document->addScript('../assets/GITLanka/angular/modals/SellReturnViewModal.js');
$document->addScript('../assets/GITLanka/angular/controllers/SellReturnController.js');
              ...
              <table id="invoice-invoice-list"  class="table table-bordered table-striped table-hover" data-hide-colums="<?php echo $hide_colums; ?>">
                <thead>
                  <tr class="bg-gray">
                    ...
                    <th class="w-10">
                      <?php echo trans('label_old_invoice_id'); ?>
                    </th>
                    <th class="w-10">
                      <?php echo trans('label_purchase_invoice_id'); ?>
                    </th>
                    <th class="w-10">
                      <?php echo trans('label_return_note'); ?>
                    </th>
                    <th class="w-10">
                      <?php echo trans('label_amount'); ?> 
                    </th>
                    <th class="w-20">
                      <?php echo trans('label_return_items'); ?> 
                    </th>
                    <th class="w-10">
                      <?php echo trans('label_returned_by'); ?> 
                    </th>
                    <th class="w-5">
