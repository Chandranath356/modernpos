...
// Add Script
$document->addScript('../assets/GITLanka/angular/modals/PurchaseLogViewModal.js');
$document->addScript('../assets/GITLanka/angular/controllers/PurchaseLogController.js');
