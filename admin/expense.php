...
// Add Script
$document->addScript('../assets/GITLanka/angular/modals/ExpenseViewModal.js');
$document->addScript('../assets/GITLanka/angular/modals/ExpenseEditModal.js');
$document->addScript('../assets/GITLanka/angular/controllers/ExpenseController.js');
