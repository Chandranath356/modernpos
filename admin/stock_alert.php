...
// Add Script
// $document->addScript('../assets/GITLanka/angular/modals/PurchaseProductModal.js');
$document->addScript('../assets/GITLanka/angular/controllers/StockAlertController.js');
