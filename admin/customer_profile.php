...
// Add ScriptS
$document->addScript('../assets/GITLanka/angular/modals/InstallmentPaymentModal.js');
$document->addScript('../assets/GITLanka/angular/modals/InstallmentViewModal.js');
$document->addScript('../assets/GITLanka/angular/modals/CustomerSubstractBalanceModal.js');
$document->addScript('../assets/GITLanka/angular/modals/CustomerAddBalanceModal.js');
$document->addScript('../assets/GITLanka/angular/controllers/CustomerController.js');
$document->addScript('../assets/GITLanka/angular/controllers/CustomerProfileController.js');
