...
// Add Script
$document->addScript('../assets/GITLanka/angular/controllers/ReportLossController.js');
$document->addScript('../assets/GITLanka/angular/controllers/ReportProfitController.js');
