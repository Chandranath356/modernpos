    ...
    <div class="nav-tabs-custom">
      ...
      <div class="tab-content">
                ...
                <td class="text-center">
                  <div class="image-thumbnail">
                    <a class="open-filemanager" data-imageid="{{img.id}}" data-toggle="image" id="thumb{{img.id}}" href="#">
                      ...
                      <img ng-show="!img.url" src="../assets/GIT Lanka/img/noimage.jpg">
                    </a>
                  </div>
                </td>
                <td>
        ...
        <div class="tab-pane<?php echo $tab_active == 'general' ? ' active' : null;?>" id="general">
            ...
            <div class="col-sm-2">
              <div class="preview-thumbnail">
                <a ng-click="POSFilemanagerModal({target:'product_image',thumb:'product_thumbnail'})" onClick="return false;" href="" data-toggle="image" id="product_thumbnail">
                  ...
                  <?php else : ?>
                    <img src="../assets/GIT Lanka/img/noimage.jpg">
                  <?php endif; ?>
                </a>
          ...
          <input type="hidden" name="old_price" value="<?php echo $product['sell_price']; ?>">
          <div class="form-group">
            <label for="updated_date" class="col-sm-3 control-label">
              <?php echo trans('label_date'); ?><i class="required">*</i>
            </label>
            <div class="col-sm-8">
              <input type="date" step="0.01" class="form-control"  value="<?php echo date("Y-m-d"); ?>" name="updated_date" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" onKeyUp="if(this.value<0){this.value='1';}" required>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <textarea class="form-control" id="edit_description" name="description" rows="3"><?php echo $product['description']; ?></textarea>
            </div>
          </div>
