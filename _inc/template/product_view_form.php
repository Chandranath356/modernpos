<div class="form-horizontal">
  <div class="box-body">
      ...
      <div class="col-sm-1">
        <div class="preview-thumbnail">
          <a onClick="return false;" id="p_thumb" href="#">
            ...
            <?php else : ?>
              <img src="../assets/GITLanka/img/noimage.jpg">
            <?php endif; ?>
          </a>
        </div>
    ...
    <?php endif; ?>
  <?php if ($product['old_product_price'] != 0 ) : ?>  
  <div class="form-group">
      <label for="sell_price" class="col-sm-3 control-label">
        <?php echo trans('label_old_price'); ?>
      </label>
      <div class="col-sm-7">
        <input type="number" step="0.01" class="form-control" id="sell_price" value="<?php echo currency_format($product['old_product_price']); ?>" name="sell_price" readonly>
      </div>
    </div>
 <?php endif; ?>
  <?php if ($product['old_product_price'] != 0 ) : ?>  
  <div class="form-group">
      <label for="sell_price" class="col-sm-3 control-label">
        <?php echo trans('label_price_updated_at'); ?>
      </label>
      <div class="col-sm-7">
        <input type="text" step="0.01" class="form-control" id="sell_price" value="<?php echo $product['updated_date']; ?>" name="sell_price" readonly>
      </div>
    </div>
 <?php endif; ?>
<input type="hidden" name="storepurchaseprice" value="<?php echo currency_format($product['sell_price']); ?>">
    <div class="form-group">
      <label for="sell_price" class="col-sm-3 control-label">
